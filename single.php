				...
				<div class="faq-archive_container clearfix">
					...
					<div class="faqs">
							<div class="next-posts-links">
								<span class="nav-next">
								<?php previous_post_link('%link','<i class="fa fa-arrow-left"></i> Newer Posts') ?></span>
								<span class="nav-previous"><?php next_post_link('%link','Older Posts <i class="fa fa-arrow-right"></i>') ?></span>
							</div>
